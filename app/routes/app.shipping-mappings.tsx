      ...
      <div className="bsure-shell">
        ...
        <div className="bsure-flow">
          <section className="bsure-card">
            ...
            <p>
              Map a Shopify shipping method name so it can be used in hide and
              rename rules. Method names are never hardcoded.
            </p>
            <Form method="post" style={{ marginTop: "18px" }}>
              <input
                type="hidden"
                name="intent"
                value="shippingMapping:create"
              />
              ...
              <div className="bsure-form-row" style={{ marginTop: "14px" }}>
                <Field label="Match type">
                  ...
                  <span className="bsure-help">
                    Exact checks full name equality. Contains checks substring.
                  </span>
                </Field>
                <Field label="Match value">
                  <input
                    className="bsure-input"
                    name="matchValue"
                    placeholder="Shopify method title as shown at checkout"
                  />
                  <span className="bsure-help">
                    Must come from Shopify admin shipping settings, not
                    hardcoded.
                  </span>
                </Field>
              </div>
              <div className="bsure-radio" style={{ marginTop: "16px" }}>
                ...
                <span>
                  ...
                  <br />
                  <span className="bsure-help">
                    Only enabled mappings appear in rule selectors.
                  </span>
                </span>
              </div>
          ...
          <section className="bsure-card">
            ...
            {mappings.length === 0 ? (
              <p className="bsure-help" style={{ marginTop: "12px" }}>
                No mappings yet. Create one above to use in shipping rules.
              </p>
            ) : (
